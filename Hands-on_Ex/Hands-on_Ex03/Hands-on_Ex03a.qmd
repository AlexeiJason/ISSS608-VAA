...
## 4.2 **Displaying multiple information on tooltip**
...
## 4.4 **Displaying statistics on tooltip**
...
## 4.5 **Hover effect with *data_id* aesthetic**
...
## 4.6 **Combining tooltip and hover effect**
...
# 6 **Coordinated Multiple Views with ggiraph**
...
# 8 **Creating an interactive scatter plot: plot_ly() method**
...
## **8.1 Working with visual variable: plot_ly() method**
...
## 8.2 **Creating an interactive scatter plot: ggplotly() method**
...
## 8.3 **Coordinated Multiple Views with plotly**
...
# 9 **Interactive Data Visualisation - crosstalk methods!**
